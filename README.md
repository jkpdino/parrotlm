...
uv run train_tokenizer.py --dataset tinystories_100k --name tinystories_bpe --vocab-size 16384
...
uv run train_tokenizer.py --dataset tinystories_100k --name tinystories_bpe_8k --vocab-size 16384
